...
from keras.layers import Input, Lambda, Conv2D, BatchNormalization, ReLU, ELU, Reshape, Concatenate, Activation
from keras.regularizers import l2

from keras_layers.keras_layer_AnchorBoxes import AnchorBoxes
from keras_layers.keras_layer_DecodeDetections import DecodeDetections
from keras_layers.keras_layer_DecodeDetectionsFast import DecodeDetectionsFast
from keras_layers.keras_layer_Pooling import HybridType2Pooling2D
from keras_layers.keras_layer_Attention2d import ChannelAttention


def hpaconv6_ssd(image_size,
                 n_classes,
                 mode='training',
    ...
    conv1 = ReLU(name='relu1')(conv1)  # 512
    pool1 = HybridType2Pooling2D(pool_size=(2, 2), name='hpool1')(conv1)  # 256
    ...
    conv2 = ReLU(name='relu2')(conv2)  # 256
    pool2 = HybridType2Pooling2D(pool_size=(2, 2), name='hpool2')(conv2)  # 128
    ...
    conv3 = ReLU(name='relu3')(conv3)  # 128
    pool3 = HybridType2Pooling2D(pool_size=(2, 2), name='hpool3')(conv3)

    conv4 = Conv2D(80, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4')(pool3)  # 64
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn4')(conv4)
    conv4 = ReLU(name='relu4')(conv4)
    pool4 = HybridType2Pooling2D(pool_size=(2, 2), name='hpool4')(conv4)

    conv5 = Conv2D(96, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv5')(pool4)
    conv5 = BatchNormalization(axis=3, momentum=0.99, name='bn5')(conv5)
    conv5 = ReLU(name='relu5')(conv5)  # 32
    pool5 = HybridType2Pooling2D(pool_size=(2, 2), name='hpool5')(conv5)

    conv6 = Conv2D(112, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6')(pool5)
    conv6 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv6)
    conv6 = ReLU(name='relu6')(conv6)  # 16

    # ---------------------attention-------------------------
    conv4 = ChannelAttention(ratio=2, name='chnlatt4')(conv4)
    conv5 = ChannelAttention(ratio=2, name='chnlatt5')(conv5)
    conv6 = ChannelAttention(ratio=2, name='chnlatt6')(conv6)
    # -------------------------------------------------------
    ...
    # print(n_boxes, n_classes, aspect_ratios, scales, two_boxes_for_ar1, steps, clip_boxes, variances, coords)
