...
def mpconv6_ssd(image_size,
    ...
    conv1 = ReLU(name='relu1')(conv1) if activation == 'ReLU' else ELU(name='elu1')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2), name='mpool1')(conv1)  # 256
    ...
    conv2 = ReLU(name='relu2')(conv2) if activation == 'ReLU' else ELU(name='elu2')(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2), name='mpool2')(conv2)  # 128
    ...
    conv3 = ReLU(name='relu3')(conv3) if activation == 'ReLU' else ELU(name='elu3')(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2), name='mpool3')(conv3)  # 64

    conv4 = Conv2D(80, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                   kernel_regularizer=l2(l2_reg), name='conv4')(pool3)  # 64
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn4')(conv4)
    conv4 = ReLU(name='relu4')(conv4) if activation == 'ReLU' else ELU(name='elu4')(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2), name='mpool4')(conv4)  # 32
    ...
    conv5 = ReLU(name='relu5')(conv5) if activation == 'ReLU' else ELU(name='elu5')(conv5)
    pool5 = MaxPooling2D(pool_size=(2, 2), name='mpool5')(conv5)  # 16

    conv6 = Conv2D(112, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                   kernel_regularizer=l2(l2_reg), name='conv6')(pool5)
    conv6 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv6)
    conv6 = ReLU(name='relu6')(conv6) if activation == 'ReLU' else ELU(name='elu6')(conv6)
